    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(help_text="Will be rendered as a Django template with the name 'object' in the context", max_length=255, verbose_name='Subject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filter', bread.querysetfield.QuerysetField(blank=True, modelfieldname='model', verbose_name='Filter')),
                ('enable', models.BooleanField(default=True)),
                ('field', models.CharField(max_length=255)),
                ('offset_type', models.CharField(choices=[('minutes', 'Minutes'), ('hours', 'Hours'), ('days', 'Days'), ('weeks', 'Weeks'), ('months', 'Months'), ('years', 'Years')], max_length=255)),
                ('offset_amount', models.IntegerField(help_text='Can be negative (before) or positive (after)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter', bread.querysetfield.QuerysetField(blank=True, modelfieldname='model', verbose_name='Filter')),
                ('enable', models.BooleanField(default=True)),
                ('type', models.TextField(choices=[('added', 'Added'), ('changed', 'Changed'), ('deleted', 'Deleted')], verbose_name='Type')),
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='triggers.action')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='contenttypes.contenttype', verbose_name='Model')),
            ],
            options={
